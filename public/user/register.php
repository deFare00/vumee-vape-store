...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (empty($errors)) {
            ...
            $_SESSION['user_address'] = $formData['address'];
        ...
        $errors['database'] = 'Terjadi kesalahan sistem. Silakan coba lagi nanti.';
    }
}
?>
...
<head>
    ...
    <title>Daftar Akun - VapeStore</title>
    ...
    <section class="register-section">
        <div class="register-container">
            <div class="register-header">
                ...
                <p>Isi form berikut untuk mendaftar sebagai member</p>
            </div>
