...
<head>
    ...
    <title>Daftar Keinginan - Vumee</title>
...
<body>
        ...
        <div class="profile-container">
            <nav class="profile-nav">
                <ul>
                    ...
                    <li><a href="wishlist.php" class="active">Daftar Keinginan</a></li>
                </ul>
            </nav>
                            ...
                            <?php foreach ($wishlist_items as $item): ?>
                                <div class="wishlist-item">
                                    ...
                                    <div class="wishlist-actions">
                                        <button class="btn btn-sm" onclick="addToCart(<?php echo $item['id']; ?>)">Tambah ke Keranjang</button>
                                        <span class="remove-wishlist" onclick="removeFromWishlist(<?php echo $item['id']; ?>)">
    ...
    <script>
        ...
        function removeFromWishlist(productId) {
            if (confirm('Hapus produk dari daftar keinginan?')) {
