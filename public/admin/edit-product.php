...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE products SET 
                          ...
                          image = ? 
                          WHERE id = ?");
    $stmt->execute([$name, $category, $price, $stock, $description, $image, $product_id]);
...
<head>
    ...
    <title>Edit Produk - Admin VapeStore</title>
    <style>
        :root {
            --primary: #4a00e0;
            --secondary: #8e2de2;
            ...
            <div class="form-container">
                <form method="POST" enctype="multipart/form-data" id="product-form">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" required placeholder="Masukkan nama produk" value="<?php echo htmlspecialchars($product['name']); ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="category" name="category" required>
                            ...
                            <?php foreach ($categories as $cat): ?>
                                <option value="<?php echo htmlspecialchars($cat); ?>" <?php echo $cat === $product['category'] ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" required placeholder="Masukkan harga" min="0" step="1000" value="<?php echo $product['price']; ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="stock">Stok</label>
                        <input type="number" id="stock" name="stock" required placeholder="Masukkan jumlah stok" min="0" value="<?php echo $product['stock']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($product['image'])): ?>
                            <p class="current-image">
                                Gambar saat ini: <?php echo htmlspecialchars($product['image']); ?>
                            </p>
                            <img src="../uploads/<?php echo htmlspecialchars($product['image']); ?>" class="image-preview" alt="Gambar Produk Saat Ini">
                        <?php endif; ?>
                        
                        <div class="file-input-wrapper">
                            <button type="button" class="file-input-button">
                                <i class="fas fa-upload"></i> Pilih Gambar Baru (Opsional)
                            </button>
                            <input type="file" id="image" name="image" accept="image/*">
                        </div>
                        <p class="file-name" id="file-name">Belum ada file dipilih</p>
                        <img id="image-preview" class="image-preview" src="#" alt="Preview Gambar Baru" style="display: none;">
                    </div>
